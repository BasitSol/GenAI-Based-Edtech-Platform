...
POLICIES = {
    "ASSESSMENT_GENERATION": RetrievalPlan(context_chunks=12, context_chars=20000,
                                            preferred_types=("TEXTBOOK", "SYLLABUS", "QUESTION_PAPER", "MARK_SCHEME", "EXAMINER_REPORT"),
                                            multi_query=True, strategy="assessment_grounding"),
